...
#Em vez de complete que usa o valor máximo, você pode usar a média :
#Z = hierarchy.linkage(dist_matrix, 'average')
#Também há a possibilidade de usar single ou centroid no linkage
